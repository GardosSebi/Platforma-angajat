...
const Permission = {
  ...
  SSM_CSSM_VIEW: "ssm:cssm:view",
  SSM_CSSM_EDIT: "ssm:cssm:edit",
  ...
  COMMUNICATIONS_CHAT_VIEW: "communications:chat:view",
  COMMUNICATIONS_EXTERNAL_MANAGE: "communications:external:manage",
...
const ROLE_PERMISSIONS: Record<string, readonly string[]> = {
  SSM_ADMIN: [
    ...
    Permission.SSM_CSSM_VIEW,
    Permission.SSM_CSSM_EDIT,
