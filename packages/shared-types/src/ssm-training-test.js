...
export function resolveTrainingTestQuestions(category) {
...
export function buildTrainingTestPresentation(questions) {
...
export function gradeTrainingTestAnswers(meta, answers, bank) {
